...
void sendYawMappingData(int i)
{
  ...
  tx_estring_value.append("|");
  tx_estring_value.append(YawMappingDataBuffer[i].distance2);
  tx_estring_value.append("|");
  tx_estring_value.append(YawMappingDataBuffer[i].motor_input);
  tx_characteristic_string.writeValue(tx_estring_value.c_str());
...
{
  nonBlockReadTOF1(&distance1);
  nonBlockReadTOF2(&distance2);
